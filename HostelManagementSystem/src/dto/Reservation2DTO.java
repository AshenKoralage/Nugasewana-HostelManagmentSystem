...
public class Reservation2DTO {
    ...
    public Reservation2DTO(String REID, String Room_no, String GID, String Payment_date, String Checking_date, String Checking_out, String Booking_date, String Key_money_amount) {
        this.REID = REID;
